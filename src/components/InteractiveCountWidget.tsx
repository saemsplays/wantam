    ...
    <>
      ...
      {!isMobile && (
        ...
        >
          {/* Minimized bar */}
          <div
            className={`absolute right-0 top-1/2 -translate-y-1/2 bg-gradient-to-r from-blue-500 to-purple-500 text-white px-3 py-8 rounded-r-lg shadow-lg cursor-pointer transition-all duration-300 hover:shadow-xl ${
