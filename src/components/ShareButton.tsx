    ...
    <div className="fixed left-4 bottom-20 md:bottom-4 z-50">
      <div className="relative">
        <motion.button
          ...
          className="w-12 h-12 bg-gradient-to-r from-emerald-600 to-blue-600 hover:bg-gradient-to-r from-emerald-700 to-blue-700 text-white rounded-full shadow-lg transition-colors duration-200 flex items-center justify-center"
